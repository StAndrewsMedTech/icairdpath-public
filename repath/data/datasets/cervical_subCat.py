...
class Cervical(Dataset):
    ...
    def load_annotations(self, file: Path, label: str) -> AnnotationSet:
        group_labels = {"low_grade": "low_grade", "Low Grade": "low_grade", "Low grade": "low_grade", "low grade" : "low_grade",
            ...
            "CGIN":"cgin","cgin":"cgin","CGin":"cgin", "Adenocarcinoma":"adenocarcinoma","AdenoCarcinoma":"adenocarcinoma","Adeno Carcinoma":"adenocarcinoma","adenocarcinoma":"adenocarcinoma",
        ...
        labels_order = ["low_grade",  "high_grade",  "malignant", "cgin","adenocarcinoma", "normal"]
...
#
    ...
    def labels(self) -> Dict[str, int]:
        return {"background" : 0, "normal": 1, "low_grade": 2 , "high_grade": 3 ,  "malignant": 4, "cgin": 5, "adenocarcinoma": 6}

    @property
    def slide_labels(self) -> Dict[str, int]:
        return {"normal": 1, "low_grade": 2 , "high_grade": 3 ,  "malignant": 4, "cgin": 5, "adenocarcinoma": 6}
...
def train():
    ...
    csv_path =  metadata_dir / "iCAIRD_Cervical_Data_Full.csv"
    cervical_df = pd.read_csv(csv_path)
    
    cervical_df = cervical_df[cervical_df['train/valid/test'] == 'train']
    ...
    df["label"] = cervical_df['Cat']
    df["tags"] = cervical_df['subCategory'] + ";" + cervical_df['train/valid/test']
...
def valid():
    ...
    cervical_df = cervical_df[cervical_df['train/valid/test'] == 'valid']
    cervical_df = cervical_df.reset_index(drop=True)
...
def test():
    ...
    cervical_df = cervical_df[cervical_df['train/valid/test'] == 'test']
    cervical_df = cervical_df.reset_index(drop=True)
